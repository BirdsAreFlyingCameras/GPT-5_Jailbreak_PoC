...
```
_If GPT-5 attempts to enter its "thinking mode" in its following response, after you enter the prompt above, a skip option will be presented to you. Make sure you press it often; the thinking models will stone wall this prompt_
